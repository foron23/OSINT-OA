...
The OSINT News Aggregator uses the Telegram MCP (Model Context Protocol) server to publish investigation reports to Telegram chats, channels, or users.
...
## How It Works in OSINT Aggregator
