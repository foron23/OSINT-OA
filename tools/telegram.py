# =============================================================================
# OSINT OA - Telegram Tools
# =============================================================================
"""
Telegram tools for message publishing.

Provides LangChain tools that interact with Telegram via Telethon:
...
Uses Telethon library for direct, robust Telegram integration.
"""
...
class TelegramSendInput(BaseModel):
    ...
    text: str = Field(description="Message text to send (HTML supported)")
...
class TelegramMCPSendTool(BaseTool):
    """
    Send messages to Telegram dialogs via Telethon.
    
    Uses the Telethon library for direct Telegram API access.
    """
    
    name: str = "telegram_mcp_send"
    description: str = """Send a message to a Telegram dialog.
    Supports HTML formatting. Use dialog names like 'cht[123456]' for groups
    ...
    async def _arun(
        ...
        """Send message asynchronously via Telethon."""
        try:
            # Import the Telethon client
...
"""
        ...
        try:
            ...
            publisher = TelethonReportPublisher(target_dialog=target)
...
class TelegramMCPListDialogsTool(BaseTool):
    ...
    async def _arun(
        ...
        try:
            ...
            dialogs = await client.list_dialogs(limit=20)
